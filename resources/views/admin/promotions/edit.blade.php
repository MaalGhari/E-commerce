        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.dashboard.promotions.update', $promotion->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="product_id" id="product_id" class="form-control" value="{{ $promotion->product_id }}" required>
                            </div>
    
                            <div class="form-group">
                                <label for="reduced_price">Reduced Price</label>
                                <input type="text" name="reduced_price" id="reduced_price" class="form-control" value="{{ $promotion->reduced_price }}" required>
                            </div>
    
                            <div class="form-group">
                                <label for="percentage_reduction">Percentage Reduction</label>
                                <input type="text" name="percentage_reduction" id="percentage_reduction" class="form-control" value="{{ $promotion->percentage_reduction }}" required>
                            </div>
    
                            <div class="form-group">
                                <label for="start_date">Start Date</label>
                                <input type="text" name="start_date" id="start_date" class="form-control" value="{{ $promotion->start_date }}" required>
                            </div>
    
                            <div class="form-group">
                                <label for="end_date">End Date</label>
                                <input type="text" name="end_date" id="end_date" class="form-control" value="{{ $promotion->end_date }}" required>
                            </div>
