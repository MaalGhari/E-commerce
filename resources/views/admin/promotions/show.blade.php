            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Product ID:</strong> {{ $promotion->product_id }}</p>
                        <p><strong>Product Name:</strong> {{ optional($promotion->product)->name }}</p>
                        <p><strong>Product Image:</strong> <img src="{{ asset('images/' . optional($promotion->product)->image) }}" alt="Product Image" width="100" height="100"></p>
                        <p><strong>Reduced Price:</strong> {{ $promotion->reduced_price }}</p>
                        <p><strong>Percentage Reduction:</strong> {{ $promotion->percentage_reduction }}%</p>
