...
<div class="card container">
    <div class="card-header">Profile Information</div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.dashboard.users.update-profile') }}" method="POST">
                @csrf 
                @method('PUT')
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-8 offset-md-4 text-center">
                        ...
                        {{-- <a href="{{ route('admin.dashboard.users.delete-profile') }}" class="btn btn-danger mt-4 ml-12">Delete Account</a> --}}
                    </div>
                </div>
            </form>
        </div>
        <a href="{{ route('admin.dashboard.home') }}"><i class="fas fa-arrow-left"></i>
